...
const msalConfigs = {
  ...
  logAnalytics: {
    workspaceId: '9cc3d684-d69f-4946-8fcf-125b25eebf69', // TODO: Replace with your actual workspace ID
    url: 'https://api.loganalytics.io/v1/workspaces',
    scopes: ['https://api.loganalytics.io/.default']
  },
  // KEEP: OpenAI configuration (still needed for query orchestration)
  openai: {
